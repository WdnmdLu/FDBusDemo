...
protected:
    ...
    {
        printf("客户端上线  MsgId: %d\n",info.mSid);
        //收到客户端上线后，发送一个广播消息，可以告诉客户端我所提供的服务有哪些
        printf("准备发送一个广播消息\n");
        char Buffer[64]="I can provide search server, please input search info\n";
        broadcast(1,Buffer,sizeof(Buffer));
    }
